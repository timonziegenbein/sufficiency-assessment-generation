...
def get_predictions(d):
    ...
    for t in d:
        ...
        #if 'me' in t.lower() or 'i' in t.lower() or 'my' in t.lower() or 'friend' in t.lower() or 'he' in t.lower():
            outcome.append(1)
        else:
            outcome.append(0)
    return outcome
...
sum_f1 = 0.0
results = []
resultPath = '/Users/zemes/DEVELOPMENT/Experiments/Sufficiency2/Baseline-heuristic/baseline-heuristic-test.bin'
