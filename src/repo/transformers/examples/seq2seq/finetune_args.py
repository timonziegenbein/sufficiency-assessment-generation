...
class SummarizationModule(BaseTransformer):
    ...
    default_val_metric = "BERTScoreF1"
    ...
    def calc_generative_metrics(self, preds, target) -> Dict:
        ...
        bert_precision = np.mean(bertscore_scores['precision'].numpy())*100
        bert_recall = np.mean(bertscore_scores['recall'].numpy())*100
        bert_f1 = np.mean(bertscore_scores['f1'].numpy())*100
