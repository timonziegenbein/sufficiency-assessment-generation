...
do
    python /scratch/hpc-prf-arguana/tgurcke/evaluating-the-local-sufficiency-of-arguments-through-generation/masterthesis/src/repo/transformers/examples/seq2seq/finetune_args.py \
        --gpus 1 \
        --do_predict \
        --data_dir /scratch/hpc-prf-arguana/tgurcke/evaluating-the-local-sufficiency-of-arguments-through-generation/masterthesis/ceph_data/intermediate/bart-AAE-v2-only-dot-direct-cola-au-full-mask-gen/${i} \
        --train_batch_size=2 \
        --eval_batch_size=2 \
        --warmup_steps 50 \
        --output_dir=/scratch/hpc-prf-arguana/tgurcke/evaluating-the-local-sufficiency-of-arguments-through-generation/masterthesis/ceph_data/output/bart-AAE-v2-only-dot-direct-cola-au-full-mask-gen/${i} \
        --num_train_epochs 3 \
