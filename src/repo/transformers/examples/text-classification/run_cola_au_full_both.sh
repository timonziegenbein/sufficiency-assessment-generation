...
do
    ...
    export TASK=cola
    export DATA_DIR=/scratch/hpc-prf-arguana/tgurcke/evaluating-the-local-sufficiency-of-arguments-through-generation/masterthesis/ceph_data/intermediate/bert-AAE-v2-only-dot-direct-cola-au-full-both/${i}
    export MAX_LENGTH=256
    export BERT_MODEL=roberta-large
    export BATCH_SIZE=2
    export NUM_EPOCHS=2
    export SEED=42
    export OUTPUT_DIR=/scratch/hpc-prf-arguana/tgurcke/evaluating-the-local-sufficiency-of-arguments-through-generation/masterthesis/ceph_data/output/bert-AAE-v2-only-dot-direct-cola-au-full-both/${i}
