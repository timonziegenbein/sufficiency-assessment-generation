...
do
    ...
    export TASK=cola
    export DATA_DIR=../../../../ceph_data/intermediate/roberta-AAE-v2-only-dot-direct-cola-au-full-replaced/${i}
    export MAX_LENGTH=256
    export BERT_MODEL=roberta-large
    export BATCH_SIZE=2
    export NUM_EPOCHS=2
    export SEED=42
    export OUTPUT_DIR=../../../../ceph_data/output/roberta-AAE-v2-only-dot-direct-cola-au-full-replaced/${i}
