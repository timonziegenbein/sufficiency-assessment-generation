...
do
    ...
    export TASK=cola
    export DATA_DIR=../../../../ceph_data/intermediate/roberta-AAE-v2-only-dot-direct-cola-conclusion/${i}
    export MAX_LENGTH=32
    export BERT_MODEL=roberta-large
    export BATCH_SIZE=1
    export NUM_EPOCHS=3
    export SEED=42
    export OUTPUT_DIR=../../../../ceph_data/output/roberta-AAE-v2-only-dot-direct-cola-conclusion/${i}
